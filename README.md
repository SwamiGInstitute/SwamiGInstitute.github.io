# Landing page for SwamiGInstitute.com
<AwoSwamiG@gmail.com>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    body{margin:0;min-height:100vh;display:flex;flex-direction:column;background:var(--bg);color:var(--ink);font:400 16px/1.55 system-ui,-apple-system,Segoe UI,Roboto,Arial,sans-serif}
    ...
    .noticebar{
      ...
      font-size:12px;
      color:#d9c6ff;
      background:rgba(187,102,255,.12);
    ...
    .logo{
      ...
      box-shadow:0 0 12px rgba(187,102,255,.30);
      margin:0 auto 18px;
    }
    ...
    /* Mission */
    .mission{color:var(--muted);font-size:14px;line-height:1.4;margin-top:40px;text-align:left}
    .mission strong{color:var(--ink);font-size:17px;display:block;margin-bottom:6px}
    .mission p{margin:4px 0}
    .mission ul{margin:6px 0 0 16px;padding:0;color:var(--muted);font-size:14px;line-height:1.3}
    .mission li{margin-bottom:4px}

    /* Donate */
    .donate{margin-top:10px;font-size:13px}
    .donate a{color:var(--muted);text-decoration:none;border-bottom:1px dotted rgba(255,255,255,.25)}
    .donate a:hover{color:var(--accent);border-bottom-color:var(--accent)}

    /* Footer */
    .footer{display:flex;flex-wrap:wrap;gap:12px;justify-content:space-between;align-items:center;border-top:1px dashed rgba(255,255,255,.15);padding-top:16px;margin-top:60px;color:var(--muted)}
    .bottom-note{font-size:9px;text-align:center;color:rgba(200,180,255,.12);margin:20px 0 6px}
  </style>
  <script>
  ...
  <div class="wrap">
    <div class="hero">
      <div class="hero-block">
        <div class="logo">
          <img src="http://myoracle.itgo.com/SwamiG.gif" alt="SwamiG logo" loading="lazy" decoding="async" fetchpriority="high" />
        </div>
